...
class LogisticRegression(LinearModel):
    def update_weight(self, x_i, y_i, learning_rate=0.001):
        ...
        # Stocastic Gradient Descent update. W is num_labels x num_features.
...
class MLP(object):
    ...
    def train_epoch(self, X, y, learning_rate=0.001):
        ...
        for x_i, y_i in zip(X, y):
            ...
            grad_z1 = self.W2.T.dot(grad_z2) * self.relu_deriv(z1) 
            grad_W1 = grad_z1[:,None]*(x_i[None,:]) 
            grad_b1 = grad_z1
